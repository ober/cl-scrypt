...
#+lispworks
(deliver 'cl-scrypt::main "../dist/lispworks/scrypt" 0 :keep-package-manipulation t :multiprocessing t :keep-eval t :keep-fasl-dump t :keep-editor t :keep-foreign-symbols t :keep-function-name t :keep-gc-cursor t :keep-keyword-names t :keep-lisp-reader t :keep-macros t :keep-modules t :keep-top-level t :license-info nil  :keep-walker t :KEEP-PRETTY-PRINTER t)

#+allegro
(progn
  (let ((lfiles '("pkgdcl.lisp" "main.lisp" "cl-scrypt.lisp")))
    (mapcar #'compile-file lfiles)
    (generate-executable "allegro"
